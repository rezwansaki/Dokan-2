...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Invoice For Purchasing Products
      </h1>
    </section>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLabel">Invoice For Purchasing Products <span style="font-size: 20px; color:black; float:right;">Total: <span id="cart_total">{{ Cart::total() }}</span></span></h2>
      ...
      {{-- form start here --}}
      <form role="form" action="{{ route('final.invoice.for.purchase') }}" method="POST">
        @csrf
        <div class="box-body">
